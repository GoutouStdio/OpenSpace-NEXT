...
C_FLAGS = -c -W -m32 -ggdb -g3 -nostdinc -fno-pic -fno-builtin -Wno-implicit-function-declaration -Wno-int-conversion -fno-stack-protector -Wimplicit-fallthrough=0 -I include
